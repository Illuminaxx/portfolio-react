         ...
         <header id="home">
            ...
            <div className="row banner">
               <div className="banner-text">
                  <h1 className="responsive-headline">Je me nomme {name}.</h1>
                  <h2>Je suis un <span>{occupation} basé à {city}</span>. {description}</h2>
                  <ul className="social">
                     {networks}
                  </ul>
               </div>
            ...
            <p className="scrolldown">
               <a className="smoothscroll" href="#about" aria-label='Go to about section'><i className="icon-down-circle"></i></a>
            </p>
